...
We will be using the Wine Quality dataset on the UC Irvine Machine Learning Repository. There are 13 variables and 4898 records. There are no missing values. 
