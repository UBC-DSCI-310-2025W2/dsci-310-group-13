...
## Summary
- [Data Collection and Preparation](#cell1) - Combined red and white wine datasets and added a new column wine_type (white/red).
- [Data Partitioning](#cell2) Split data into training and testing sets (70-30)
- [EDA](#cell3) - Exploratory Data Analysis to identify how variables correlate with the response variable.
- [Model Training](#cell4) - Used KNN classifier.
- [Model Evaluation](#cell5) - Evaluate predictions made on the test set. Metrics used were F1 score, accuracy, classification report and confusion matrix.
- [Results and Discussion](#cell6) - Results of the model and conclusion
...
<a id="cell1"></a>
### 1. Data Acquisition
The primary data source consists of two separate CSV files hosted on the UCI Machine Learning Repository (Cortez et al., 2009), representing red and white wine samples. We begin by loading these files directly into our environment.
...
Cortez, P., Cerdeira, A., Almeida, F., Matos, T., & Reis, J. (2009). *Wine Quality [Dataset]*. UCI Machine Learning Repository. https://doi.org/10.24432/C56S3T. <br>
Cover, T., & Hart, P. (1967). *Nearest neighbor pattern classification*. IEEE Transactions on Information Theory, 13(1), 21-27. https://doi.org/10.1109/TIT.1967.1053964 <br>
